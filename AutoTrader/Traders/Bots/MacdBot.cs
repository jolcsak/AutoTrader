...
namespace AutoTrader.Traders.Bots
{
    public class MacdBot : TradingBotBase, ITradingBot
    {
        ...
        public override Predicate<IIndexedOhlcv> BuyRule => Rule.Create(c => c.IsEmaBearish(48) && c.IsEmaBearish(96)).And(c => c.IsAboveEma(24) && c.IsBelowEma(48) && c.IsBelowEma(96));
        public override Predicate<IIndexedOhlcv> SellRule => Rule.Create(c => c.IsEmaBullish(48) && c.IsEmaBullish(96)).And(c => c.IsAboveEma(24) && c.IsAboveEma(96));
